...
import {FormikAbstractation, FormikBasicPage, FormikComponents, FormikYupPage, RegisterPage, RegisterFormikPage, DynamicForm} from '../3-forms/pages';
      ...
      <div className="main-layout">
        <nav>
          ...
          <ul>
            ...
            <li>
              <NavLink to="/formik-register" activeClassName="nav-active" exact>Register Formik Page</NavLink>
            </li>
            <li>
